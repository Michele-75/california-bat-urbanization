...
| `04_build_grid_covariates.R` | Compute grid-cell-level covariates: VIIRS radiance, NLCD % developed, PAD-US % protected, WorldPop population density | Accessible grid, raw rasters/vectors | `data/processed/covariates_grid/grid_covariates_10km.csv` |
