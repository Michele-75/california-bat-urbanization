...
# Purpose:
#   Summarize annual VIIRS nighttime lights (EOG VNL) to California county × year.
#
# Raw data requirements:
#   Annual VIIRS Visible Nighttime Lights (VNL) GeoTIFFs produced by the
#   Earth Observation Group (EOG), Payne Institute for Public Policy,
#   Colorado School of Mines.
#
#   - Versions used:
#       * VNL v2.1 for years 2012–2021
#       * VNL v2.2 for years 2022–present
#   - Product: annual average radiance ("average_masked") GeoTIFFs
#   - Units: nW/cm^2/sr
#
# Expected raw data directory structure:
#   data/raw/viirs/
#     v21/   # VNL v2.1 files (2012–2021)
#       *.tif
#     v22/   # VNL v2.2 files (2022–present)
#       *.tif
#
# Notes:
#   - Filenames must contain a 4-digit year (e.g., 2019).
#   - GeoTIFFs should be uncompressed (.tif), not .gz.
#   - County boundaries must be generated by running R/02_get_ca_counties.R first

#Run script with source(here::here("R", "03_process_viirs_county_year.R"))
