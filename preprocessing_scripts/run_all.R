# preprocessing_scripts/run_all.R
# Purpose: Execute the full data processing pipeline in order.
...
#   - Raw covariate rasters placed in data/raw/ (see 04_build_grid_covariates.R header)
...
source(here::here("preprocessing_scripts", "02_get_ca_boundary.R"))

cat("Step 3: Build 10 km grid and accessible domain...\n")
source(here::here("preprocessing_scripts", "03_build_grid_and_domain.R"))

cat("Step 4: Compute grid-level covariates...\n")
source(here::here("preprocessing_scripts", "04_build_grid_covariates.R"))

cat("Step 5: Build grid-level species presence panel...\n")
source(here::here("preprocessing_scripts", "05_build_grid_presence.R"))

cat("Step 6: Merge presence and covariates into final dataset...\n")
source(here::here("preprocessing_scripts", "06_build_grid_model_dataset.R"))
